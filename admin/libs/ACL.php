...
class ACL
{
	...
	public static $role_pages = array(
			'admin' =>
						array(
							'data_banner' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'data_masjid' => array('list','view','add','edit', 'editfield','delete','import_data','lengkapi_data_masjid','cek_data_mesjid'),
							'data_menus' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'info_masjid' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'artikel_masjid' => array('list','view','add','edit', 'editfield','delete'),
							'users' => array('list','view','add','edit', 'editfield','delete','userregister','accountedit','accountview'),
							'banner_donasi' => array('list','view','add','edit', 'editfield','delete')
						),
			...
			'admin-masjid' =>
						array(
							...
							'data_menus' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'info_masjid' => array('list','view','add','edit', 'editfield','delete','import_data'),
							'artikel_masjid' => array('list','view','add','edit', 'editfield','delete','import_data'),
			...
			'user' =>
						array(
							'data_masjid' => array('lengkapi_data_masjid','cek_data_mesjid')
						)
		);
