                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <div class="dropzone required" input="#ctrl-foto" fieldname="foto"    data-multiple="false" dropmsg="Choose files or drag and drop files to upload"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="1" maximum="1">
                                                            ...
                                                            <small class="form-text">Max 1Mb</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
