...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">Edit  Info Masjid</h4>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="bg-light p-3 animated fadeIn page-content">
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("info_masjid/edit/$page_id/?csrf_token=$csrf_token"); ?>" method="post">
                            <div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-nama_penceramah"  value="<?php  echo $data['nama_penceramah']; ?>" type="text" placeholder="Enter Nama Penceramah"  required="" name="nama_penceramah"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group ">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-alamat_penceramah"  value="<?php  echo $data['alamat_penceramah']; ?>" type="text" placeholder="Enter Alamat Penceramah"  required="" name="alamat_penceramah"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-muadzin"  value="<?php  echo $data['muadzin']; ?>" type="text" placeholder="Enter Muadzin"  required="" name="muadzin"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-imam"  value="<?php  echo $data['imam']; ?>" type="text" placeholder="Enter Imam"  required="" name="imam"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
